...
<head>
    ...
    <script type="text/javascript" src="js/com.lingting.controller/itemController.js">  </script>
</head>

<body ng-app="pinyougou" ng-com.lingting.controller="itemController" ng-init="num=1;loadSku()">

<!--页面顶部 开始-->
<#include "head.ftl">
<!--页面顶部 结束-->
<#-- 数据集体处理的地方 -->
<#-- 将传递的json字符串数据转换成一个对象 -->
                            ...
                            <dl>
                                ...
                                <#list specification.attributeValue as item>
                                    <dd>
                                        ...
                                        ng-click="selectSpecifiction('${specification.attributeName}', '${item}')">
                                            ${item}
